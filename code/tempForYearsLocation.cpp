...
void plotYears(){
	...
	TH1D* LundColdHist = new TH1D("hPhi", "Lund; Day; Temperature", 
			Lund.datavector.size() -1, 0, Lund.datavector.size());
	...
	LundColdHist->SetLineColor(kRed);
	...
	TH1D* LuleColdHist = new TH1D("hPhi", "Lulea; Day; Temperature", 
			Lule.datavector.size() -1, 0, Lule.datavector.size());
	...
	LuleColdHist->SetLineColor(kRed);
	...
	TH1D* FalsterWarmHist = new TH1D("hPhi", "Falsterbo; Day; Temperature", 
	...
	FalsterWarmHist->SetMinimum(-15);
	FalsterWarmHist->SetMaximum(24);
